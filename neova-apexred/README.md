...
<p align="center">
  <img src="./docs/logo.png" alt="Neova ApexRed" width="300" />
</p>

Neova ApexRed is "[Atomic Red Team](https://github.com/redcanaryco/atomic-red-team)™" for the cloud, allowing to emulate offensive attack techniques in a granular and self-contained manner.
...
Neova ApexRed is a self-contained Go binary.

See the documentation at **[stratus-red-team.cloud](https://stratus-red-team.cloud/)**:
- [Neova ApexRed Concepts](https://stratus-red-team.cloud/user-guide/getting-started/#concepts)

- [Installing Neova ApexRed](https://stratus-red-team.cloud/user-guide/getting-started/#installation) - Homebrew formula, Docker image and pre-built binaries available
...
You can install specific versions (or latest) of neova-apexred using [asdf](https://asdf-vm.com/) and this [neova-apexred plugin](https://github.com/asdf-community/asdf-stratus-red-team):
...
The following section lists posts and projects from the community leveraging Neova ApexRed.

Open-source projects:
- [Threatest](https://github.com/DataDog/threatest)
- [AWS Threat Detection with Neova ApexRed](https://github.com/sbasu7241/AWS-Threat-Simulation-and-Detection)


Videos:
- [Reproducing common attacks in the cloud with Neova ApexRed](https://www.youtube.com/watch?v=M5DGXWF2ld0)
- [Neova ApexRed: AWS EC2 Instance Credential Theft | Threat SnapShot](https://www.youtube.com/watch?v=TVS-M6DrSPw)
- [Automated Attack Simulation in AWS for Red Teaming](https://www.youtube.com/watch?v=O_vNAKLnSc0)

Blog posts:
- [AWS threat emulation and detection validation with Neova ApexRed and Datadog Cloud SIEM](https://www.datadoghq.com/blog/aws-threat-emulation-detection-validation-datadog/)
- [Adversary emulation on AWS with Neova ApexRed and Wazuh](https://wazuh.com/blog/adversary-emulation-on-aws-with-stratus-red-team-and-wazuh/)
- [Sky’s the Limit: Neova ApexRed for Azure](https://blog.detect.dev/posts/azure_for_stratus.html)
...
- [Detonating attacks with Datadog Neova ApexRed](https://chrisdunne.com/post/detonating-attacks-with-datadog-stratus-red-team)
- [AWS CloudTrail cheatsheet](https://invictus-ir.medium.com/aws-cloudtrail-cheat-sheet-dcf2b92e37e2)
- [Adversary emulation on GCP with Neova ApexRed and Wazuh](https://wazuh.com/blog/adversary-emulation-on-gcp-with-stratus-red-team-and-wazuh/)
...
- [AWS Cloud Detection Lab: Cloud Pen-testing with Neova ApexRed](https://medium.com/@goodycyb/aws-cloud-detection-lab-1%EF%B8%8F%E2%83%A3-%EF%B8%8F-cloud-pen-testing-with-stratus-red-team-tool-69b4fab24743)

Talks:
- [Purple Teaming & Adversary Emulation in the Cloud with Neova ApexRed, DEF CON Cloud Village 2022](https://www.youtube.com/watch?v=rXFFuYbkntU) (recorded after the event as the talks were not recorded)
- [Threat-Driven Development with Neova ApexRed](https://www.youtube.com/watch?v=AbWwcqLwcYI) by Ryan Marcotte Cobb
- [Cloudy With a Chance of Purple Rain: Leveraging Neova ApexRed - BSides Portland 2022](https://www.youtube.com/watch?v=Oq9ObzATZDI)
...
## Using Neova ApexRed as a Go Library
...
Similar projects (see [how Neova ApexRed compares](https://stratus-red-team.cloud/comparison/)):
